...
const FAMOUS_SHOPS: Record<string, { name: string; type: string; hours: string; emoji: string; mapsUrl: string; brandId?: string }[]> = {
  "oxford-street": [
    { name: "Selfridges", type: "Luxury department store", hours: "Mon-Sat 9:30-21:00; Sun 11:30-18:00", emoji: "🏬", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Selfridges+Oxford+Street+London", brandId: "selfridges" },
    { name: "Zara", type: "Fast fashion", hours: "Mon-Sat 10:00-21:00; Sun 12:00-18:00", emoji: "👗", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Zara+Oxford+Street+London", brandId: "zara" },
    { name: "H&M Flagship", type: "High street fashion", hours: "Mon-Sat 9:00-21:00; Sun 11:00-18:00", emoji: "🛍️", mapsUrl: "https://www.google.com/maps/search/?api=1&query=H%26M+Oxford+Street+London", brandId: "hm-flagship" },
    { name: "Nike Town", type: "Sportswear flagship", hours: "Mon-Sat 10:00-20:00; Sun 12:00-18:00", emoji: "👟", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Nike+Town+Oxford+Street+London", brandId: "nike-town" },
    { name: "John Lewis", type: "Department store", hours: "Mon-Sat 9:30-20:00; Sun 12:00-18:00", emoji: "🏪", mapsUrl: "https://www.google.com/maps/search/?api=1&query=John+Lewis+Oxford+Street+London", brandId: "john-lewis" },
    { name: "Primark Flagship", type: "Affordable fashion — largest in world", hours: "Mon-Sat 8:00-22:00; Sun 11:30-18:00", emoji: "🛒", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Primark+Oxford+Street+London", brandId: "primark-flagship" },
  ],
  "carnaby-street": [
    { name: "Irregular Choice", type: "Quirky footwear and accessories", hours: "Mon-Sat 10:00-19:00; Sun 11:00-18:00", emoji: "👠", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Irregular+Choice+Carnaby+Street+London", brandId: "irregular-choice" },
    ...
    { name: "Dr. Martens", type: "Iconic British boots", hours: "Mon-Sat 10:00-19:00; Sun 12:00-18:00", emoji: "🥾", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Dr+Martens+Carnaby+Street+London", brandId: "dr-martens" },
...
export default function ShoppingDetailPage({ params }: Props) {
  const item = (shopping.items as any[]).find((s: any) => s.id === params.id);
  if (!item) notFound();
