...
export const metadata: Metadata = {
  title: "Emergency Help London | TAP LONDON",
  description: "Emergency numbers, hospitals and safety tips in London."
};
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-9 max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-ink/70 dark:text-cream/70">
            Hospitals, police, safety tips and emergency numbers for London visitors.
          </p>
        </div>
        <DirectoryClient
          items={items}
