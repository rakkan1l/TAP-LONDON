...
export default function Navbar() {
  ...
  // Fetch London weather — free API, no key needed
  useEffect(() => {
    fetch(
    ...
    <header className="sticky top-0 z-50 border-b border-white/35 bg-cream/86 shadow-sm backdrop-blur-xl">
        ...
        <div className="hidden items-center gap-4 lg:flex">
          ...
          {weather && (
            <div style={{
              ...
              <span style={{ fontSize: "0.78rem", fontWeight: 700, color: "#1a1a2e" }}>
                {weather.temp}°C
              </span>
      ...
      {weather && !open && (
        <div style={{
          ...
          <span style={{ fontSize: "0.7rem", color: "#666" }}>{weather.desc}</span>
        </div>
      )}
